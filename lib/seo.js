...
export const getWebsiteSchema = () => <JsonLd data={{
...
export const getPersonSchema = () => <JsonLd data={{
          "@context": "https://schema.org",
          "@type": "Person",
...
export const getTestimonialSchema = (name, review, rating = "5") => <JsonLd data={{
          "@context": "https://schema.org",
          "@type": "Review",
          "itemReviewed": {
...
export const getContactSchema = () => <JsonLd data={{
          "@context": "https://schema.org",
          "@type": "ContactPoint",
...
export const getSingleServiceSchema = (service) => <JsonLd key={service.slug} data={{
          "@context": "https://schema.org",
          "@type": "Service",
          "name": service.title,
...
export const getFAQSchema = (faqs = []) => {
  ...
  return <JsonLd data={buildFaqSchema(normalizedFaqs)} />;
};
...
export const getServiceItemListSchema = () => <JsonLd data={{
          "@context": "https://schema.org",
          "@type": "ItemList",
...
export const getLocalBusinessSchema = () => <JsonLd data={{
          "@context": "https://schema.org",
          "@type": "ProfessionalService",
          "name": "William Purnell - AI Automation Developer London",
          "image": absoluteUrl("/android-chrome-512x512.png"),
...
export const getAutomationServiceSchema = () => <JsonLd data={{
          "@context": "https://schema.org",
          "@type": "Service",
