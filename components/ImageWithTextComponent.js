...
export default function ImageWithTextComponent({
  ...
  switch (format) {
    case "text-left":
      return (
        <FadeInAndOutWrapper className="flex max-w-7xl mx-auto px-8 py-16 md:py-32 items-center flex-col-reverse md:flex-row">
    ...
    case "text-right":
      return (
        <FadeInAndOutWrapper className="flex max-w-7xl mx-auto px-8 py-16 md:py-32 items-center flex-col md:flex-row">
